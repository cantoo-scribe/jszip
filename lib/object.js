...
var WebStreamInputAdapter = require("./stream/WebStreamInputAdapter");
...
var fileAdd = function(name, data, originalOptions) {
    ...
    if (data instanceof CompressedObject || data instanceof GenericWorker) {
        ...
        // the input is available synchronously: prepare it now, keep the
        // result for the sync API and share it with the async one.
        try {
        ...
        // asynchronous source (Blob, Promise...), only usable with the async API
